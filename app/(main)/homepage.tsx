...
const CAROUSEL = [
  ...
  {
    id: "c2",
    uri: "https://images.unsplash.com/photo-1688107389738-1f9c845452d1?q=80&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    quote: "Pain is temporary. Pride is forever.",
    sub: "Push beyond your limits.",
  },
  {
    id: "c3",
    uri: "https://images.unsplash.com/photo-1758506971683-c080e6f16ce9?q=80&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    quote: "Your only competition is yesterday's you.",
    sub: "Run. Recover. Repeat.",
  },
  {
    id: "c4",
    uri: "https://images.unsplash.com/photo-1558247130-edd2606d5a78?q=80&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
const sm = StyleSheet.create({
  ...
  statBorder: { borderLeftWidth: 1, borderLeftColor: C.red },
  statV: { fontSize: 16, fontWeight: "900", color: C.white },
  statL: { fontSize: 10, color: C.grey, marginTop: 2, textAlign: "center" },
  divider: {
    height: 1,
    backgroundColor: C.lightgrey,
    marginHorizontal: 20,
  ...
  itemIconRed: { backgroundColor: C.black },
...
function DigitalTwinTab() {
  ...
  const DT_ITT = require("../../assets/images/DT_ITT.png");
...
const dt = StyleSheet.create({
  ...
  subTabBtnActive: { backgroundColor: C.black },
  ...
  return (
    <View>
      ...
      <View style={sk.headerBanner}>
        ...
        <View style={sk.pointsProgressWrap}>
          <View style={sk.pointsProgress}>
            <View
              style={[
                sk.pointsProgressFill,
                { width: `${(SPARK_POINTS / 5000) * 100}%` as any },
              ]}
            />
          </View>
          <Text style={sk.pointsNext}>1,488 pts to next tier</Text>
        </View>
      </View>
...
const sk = StyleSheet.create({
  ...
  pointsSub: { fontSize: 13, color: "rgba(255,255,255,0.6)", marginTop: -4 },
  ...
  toggleText: { fontSize: 14, fontWeight: "700", color: C.black },
      ...
      >
        ...
        <View style={{ height: HERO_H, position: "relative" }}>
          ...
          <SafeAreaView style={g.heroTopBar} pointerEvents="box-none">
            <Text style={g.logo}>Runverve</Text>
            <TouchableOpacity
              style={g.menuBtn}
        ...
        <View style={g.statsHeaderRow}>
          <Text style={g.statsTitle}>Today's Stats</Text>
          <TouchableOpacity>
        ...
        >
          {[
            ...
            return (
              <View
                key={stat.id}
                style={[g.statCard, isEven ? g.statCardDark : g.statCardLight]}
              >
                <View style={g.ringWrap}>
                  <Ring
                    pct={stat.pct}
                    color={isEven ? C.white : C.red}
                    size={58}
                    strokeW={5}
                  />
                  <View
                ...
                <Text style={[g.statVal, { color: isEven ? C.white : C.red }]}>
                  {stat.value}
                </Text>
                <Text
                  style={[
                    g.statUnit,
                    { color: isEven ? "rgba(255,255,255,0.6)" : C.grey },
                  ]}
                >
                  {stat.unit}
                </Text>
                <Text
                  style={[
                    g.statLbl,
                    { color: isEven ? "rgba(255,255,255,0.8)" : C.black },
                  ]}
                >
                  {stat.label}
                </Text>
...
const g = StyleSheet.create({
  ...
  // Dock
  dockSafe: { backgroundColor: C.black },
  dock: {
    flexDirection: "row",
    backgroundColor: C.black,
    paddingTop: 8,
  ...
  dockItem: { flex: 1, alignItems: "center", gap: 5 },
  dockIconWrap: {
    width: 48,
    height: 48,
    borderRadius: 14,
  ...
  dockIconWrapActive: { backgroundColor: C.red, borderRadius: 14 },
  dockLabel: {
    fontSize: 10,
    fontWeight: "600",
